        ...
        Column {
            ...
            Item {
                ...
                ColumnLayout {
                    ...
                    Text {
                        id: element1
                        text: qsTr("Informations du palmares")
                        font.pixelSize: 12
                    }
                    ...
                    GridLayout {
                        ...
                        TextField {
                            id: titleNameField
                            text: TitlesViewModelContext.title.name
                            placeholderText: "Nom du palmares"
                        }

                        Binding {
                            target: TitlesViewModelContext.title
                            property: "name"
                            value: titleNameField.text
                        }


                        TextField {
                            id: titleDateField
                            text: TitlesViewModelContext.title.date
                            placeholderText: "Nom du palmares"
                        }
                    ...
                    RowLayout {
                        ...
                        Button {
                            id: button1
                            onClicked: {
                                TitlesViewModelContext.saveTitle()
                                stackView.pop()
                            }
